        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputData = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_GymCenters_GymCenterId",
                        column: x => x.GymCenterId,
                        principalTable: "GymCenters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AIRecommendations_AspNetUsers_MemberId",
                table: "AIRecommendations",
                column: "MemberId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
